...
const ListingForm = (props) => {
    ...
    const onSubmit = e => {
        ...
        setLoading(true);
        console.log({ sale_type, price, bedrooms, home_type, bathrooms, sqft, days_listed, has_photos, open_house, keywords })
    ...
    return (
        <form className='listingform' onSubmit={e => onSubmit(e)}>
            <div className='row'>
                ...
                <div className='col-1-of-6'>
                    <div className='listingform__section'>
                        <label className='listingform__label' htmlFor='price'>Max Price</label>
